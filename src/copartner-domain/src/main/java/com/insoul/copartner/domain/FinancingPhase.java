 ...
 */
@Entity
@Table(name = "financing_phase", catalog = "copartner")
@NamedQueries({ @NamedQuery(name = "FinancingPhase.getAllListed", query = "FROM FinancingPhase WHERE isListed = true") })
public class FinancingPhase extends BaseEntity {
    ...
    public boolean equals(Object obj) {
        ...
        if (getClass() != obj.getClass())
            return false;
        FinancingPhase other = (FinancingPhase) obj;
        if (isListed == null) {
