...
public class PioneerParkController extends WebBase {
	...
	public ModelAndView update(@PathVariable Long pioneerParkId, @Valid PioneerParkRequest request, BindingResult result) {
	    ...
	    pioneerPark.setArea(StringUtils.defaultString(request.getAreaV()));
	    pioneerPark.setCity(StringUtils.defaultString(request.getCityV()));
	    ...
	    pioneerPark.setProvince(request.getProvinceV());
