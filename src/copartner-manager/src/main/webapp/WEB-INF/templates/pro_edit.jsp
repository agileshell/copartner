...
<body>
	...
	<div class="content">
		...
		<div class="mainbar">
			<div class="page-head">
				<h2 class="pull-left">编辑项目</h2>
				<div class="bread-crumb pull-right">
					<a href="/home"><i class="icon-home"></i>首页</a><span class="divider">/</span>编辑项目
				</div>
						...
						<div class="col-md-12">
							<div class="widget wgreen">
								...
								<div class="widget-content">
									<div class="padd">
										<form class="form-horizontal" role="form" action="/pro/update/${phase.id}" method="post" enctype="multipart/form-data">
