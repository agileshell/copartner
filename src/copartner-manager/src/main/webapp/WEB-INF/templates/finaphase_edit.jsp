						...
						<div class="col-md-12">
							<div class="widget wgreen">
								<div class="widget-head">
									<div class="pull-left">编辑融资阶段</div>
									<div class="clearfix"></div>
								</div>
								<div class="widget-content">
									<div class="padd">
										<form id="edit_finaphase_form" class="form-horizontal" role="form" action="/finaphase/update/${phase.id}" method="post">
											<div class="form-group">
												<label class="col-lg-5 control-label" for="name">融资阶段名称<span class="cofrequired">*</span>:</label>
												<div class="col-lg-7">
													<input name="name" id="name" value="${phase.name}" type="text" class="form-control" placeholder="融资阶段名称"></input>
												</div>
											</div>
											<div class="form-group">
