...
<body>
	...
	<div class="content">
		...
		<div class="mainbar">
			<div class="page-head">
				<h2 class="pull-left">行业列表</h2>
				<div class="bread-crumb pull-right">
					<a href="/home"><i class="icon-home"></i>首页</a><span class="divider">/</span>行业列表
				</div>
									...
									<table class="table table-striped table-bordered table-hover">
										...
										<tbody>
											<c:if test="${!success}">
												...
												<tr><td colspan="5" style="text-align: center;"><a class="btn btn-default btn-sm" href="add">新建行业</a></td></tr>
											</c:if>
											<c:if test="${success}">
