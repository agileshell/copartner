									...
									<div class="padd">
										<form class="form-horizontal" role="form" action="/news/list" method="get">
											<div class="form-group">
												...
												<div class="col-lg-4">
													<input name="id" id="id" value="${req.id}" type="text" class="form-control" placeholder="新闻动态ID">
												</div>
									...
									<table class="table table-striped table-bordered table-hover">
										...
										<tbody>
											<c:if test="${!success}">
												...
												<tr><td colspan="8" style="text-align: center;"><a class="btn btn-default btn-sm" href="/news/add">新建新闻动态</a></td></tr>
											</c:if>
											<c:if test="${success}">
													...
													<tr>
														...
														<td>
															<jsp:include page="control/commons-status.jsp">
																...
																<jsp:param value="/news/update_status/${c.id}" name="url"/>
															</jsp:include>
														</td>
														<td>${c.gmtcreated}</td>
														<td>${c.clicks}次</td>
