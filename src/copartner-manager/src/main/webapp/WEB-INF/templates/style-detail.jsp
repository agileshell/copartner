									...
									<div class="padd form-horizontal">
										<c:if test="${!success}">
											<div class="form-group">
												<div class="col-lg-12" style="text-align: center;">主题不存在!!!</div>
											</div>
										</c:if>
										<c:if test="${success}">
											<div class="form-group">
												<label class="col-lg-5 control-label" >主题名称:</label>
												<div class="col-lg-7">${style.name}</div>
											</div>
											<div class="form-group">
												<label class="col-lg-5 control-label" >主题描述:</label>
												<div class="col-lg-7">${style.description}</div>
											</div>
											<div class="form-group">
