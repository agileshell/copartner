						...
						<div class="col-md-12">
							<div class="widget wgreen">
								<div class="widget-head">
									<div class="pull-left">新建项目阶段</div>
									<div class="clearfix"></div>
								</div>
								<div class="widget-content">
									<div class="padd">
										<form id="add_phase_form" class="form-horizontal" role="form" action="/phase/save" method="post">
											<div class="form-group">
												<label class="col-lg-5 control-label" for="name">项目阶段名称<span class="cofrequired">*</span>:</label>
												<div class="col-lg-7">
													<input name="name" id="name" type="text" class="form-control" placeholder="项目阶段名称"></input>
												</div>
											</div>
											<div class="form-group">
