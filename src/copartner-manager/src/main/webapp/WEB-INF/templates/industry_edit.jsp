...
<body>
	...
	<div class="content">
		...
		<div class="mainbar">
			<div class="page-head">
				<h2 class="pull-left">编辑行业</h2>
				<div class="bread-crumb pull-right">
					<a href="/home"><i class="icon-home"></i>首页</a><span class="divider">/</span>编辑行业
				</div>
						...
						<div class="col-md-12">
							<div class="widget wgreen">
								<div class="widget-head">
									<div class="pull-left">编辑行业</div>
									<div class="clearfix"></div>
								</div>
								<div class="widget-content">
									<div class="padd">
										<form class="form-horizontal" role="form" action="/industry/update/${industry.id}" method="post" enctype="multipart/form-data">
											...
											<div class="form-group">
												...
												<div class="col-lg-7">
													<jsp:include page="control/commons-listed.jsp">
														<jsp:param value="${industry.isListed}" name="listed"/>
