						...
						<div class="col-md-12">
							<div class="widget">
								<div class="widget-content">
									<div class="padd">
										<form class="form-horizontal" role="form" action="/team/list" method="get">
											<div class="form-group">
												<label class="col-lg-2 control-label" for="id">ID:</label>
												<div class="col-lg-4">
													<input name="id" id="id" value="${req.id}" type="text" class="form-control" placeholder="团队规模ID">
												</div>
												<label class="col-lg-2 control-label" for="name">团队规模名称:</label>
												<div class="col-lg-4">
													<input name="name" id="name" value="${req.name}" type="text" class="form-control" placeholder="团队规模名称">
												</div>
											</div>
											<div class="form-group">
							...
							<div class="widget">
								<div class="widget-head">
									<div class="pull-left">团队规模列表</div>
									<div class="clearfix"></div>
								</div>
								<div class="widget-content">
									<table class="table table-striped table-bordered table-hover">
										...
										<tbody>
											<c:if test="${!success}">
												...
												<tr><td colspan="5" style="text-align: center;"><a class="btn btn-default btn-sm" href="add">新建团队规模</a></td></tr>
											</c:if>
											<c:if test="${success}">
												<c:forEach var="c" items="${teamSizeList}" varStatus="status">
													<tr>
														<td>${c.id}</td>
														<td>${c.name}</td>
														<td>
