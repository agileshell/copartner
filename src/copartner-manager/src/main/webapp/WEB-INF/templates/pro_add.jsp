...
<body>
	...
	<div class="content">
		...
		<div class="mainbar">
			<div class="page-head">
				<h2 class="pull-left">新建项目</h2>
				<div class="bread-crumb pull-right">
					<a href="/home"><i class="icon-home"></i>首页</a><span class="divider">/</span>新建项目
				</div>
						...
						<div class="col-md-12">
							<div class="widget wgreen">
								<div class="widget-head">
									<div class="pull-left">新建项目</div>
									<div class="clearfix"></div>
								</div>
								<div class="widget-content">
									<div class="padd">
										<form class="form-horizontal" role="form" action="/pro/save" method="post" enctype="multipart/form-data">
											<div class="form-group">
												<label class="col-lg-5 control-label" for="name">项目名称:</label>
												<div class="col-lg-7">
													<input name="name" id="name" type="text" class="form-control" placeholder="项目名称"></input>
												</div>
											</div>
											<div class="form-group">
