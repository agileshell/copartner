					...
					<div class="col-md-12">
						<div class="widget">
							<div class="widget-content">
								<div class="padd">
									<form class="form-horizontal" role="form" action="/campaign/list" method="get">
										<div class="form-group">
											<label class="col-lg-2 control-label" for="id">ID:</label>
											<div class="col-lg-4">
												<input name="id" id="id" value="${req.id}" type="text" class="form-control" placeholder="活动ID">
											</div>
								...
								<table class="table table-striped table-bordered table-hover">
									...
									<tbody>
										<c:if test="${!success}">
											...
											<tr><td colspan="5" style="text-align: center;"><a class="btn btn-default btn-sm" href="/campaign/add">新建活动</a></td></tr>
										</c:if>
										<c:if test="${success}">
											<c:forEach var="c" items="${campaignList}" varStatus="status">
												<tr>
													<td>${c.id}</td>
													...
													<td>
														<jsp:include page="control/commons-status.jsp">
															...
															<jsp:param value="/campaign/update_status/${c.id}" name="url"/>
														</jsp:include>
													</td>
													<td>${c.gmtcreated}</td>
													<td>
