						...
						<div class="col-md-12">
							<div class="widget wgreen">
								...
								<div class="widget-content">
									<div class="padd">
										<form id="edit_status_form" class="form-horizontal" role="form" action="/status/update/${status.id}" method="post">
											<div class="form-group">
												<label class="col-lg-5 control-label" for="name">创业状态名称<span class="cofrequired">*</span>:</label>
												<div class="col-lg-7">
